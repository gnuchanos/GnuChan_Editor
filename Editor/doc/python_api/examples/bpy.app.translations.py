...
`How to Translate Blender <https://wiki.gnuchanos.org/index.php/Dev:Doc/Process/Translate_Blender>`_ and
`Using i18n in Blender Code <https://wiki.gnuchanos.org/index.php/Dev:Source/Interface/Internationalization>`_
for more info.
...
# See also https://wiki.gnuchanos.org/index.php/Dev:Doc/Process/Translate_Blender#Translating_non-official_addons
