...
public:
	 ...
	 *
	 * Removes window decorations and resizes the window to the specified dimensions,
	 * typically matching the full screen resolution.
	 */
	virtual GHOST_TSuccess setClientBorderless() = 0;
