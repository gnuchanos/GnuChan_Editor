...
if(NOT WITH_PYTHON_MODULE)
	set_property(DIRECTORY PROPERTY VS_STARTUP_PROJECT RangeEngine)
endif()
...
list(APPEND PLATFORM_LINKLIBS
	ws2_32 vfw32 winmm kernel32 user32 gdi32 comdlg32 version
	advapi32 shfolder shell32 ole32 oleaut32 uuid psapi Dbghelp Dwmapi
)
...
if(WITH_PYTHON)
	set(PYTHON_VERSION 3.11) # CACHE STRING)
...
if(WITH_TBB)
  ...
  if(WITH_GAMEENGINE)
	message(STATUS "TBB disabled, also disabling GameEngine")
	set(WITH_GAMEENGINE OFF)
  endif()
endif()
...
if(WITH_CODEC_SNDFILE)
	...
	set(LIBSNDFILE_LIBRARIES ${SNDFILE}/lib) # TODO, deprecate
	set(LIBSNDFILE_LIBPATH ${LIBSNDFILE}/libsndfile-1.lib)
