...
static void ImGui_ImplOpenGL3_SetupRenderState(ImDrawData* draw_data, int fb_width, int fb_height, GLuint vertex_array_object, ImVec2 KX_Viewport)
{
    ImGui_ImplOpenGL3_Data* bd = ImGui_ImplOpenGL3_GetBackendData();
    ...
    GL_CALL(glViewport(KX_Viewport.x, KX_Viewport.y, (GLsizei)fb_width, (GLsizei)fb_height));
...
void    ImGui_ImplOpenGL3_RenderDrawData(ImDrawData* draw_data, ImVec2 KX_Viewport)
{
...
#endif
    ImGui_ImplOpenGL3_SetupRenderState(draw_data, fb_width, fb_height, vertex_array_object, KX_Viewport);
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                GL_CALL(glScissor((int)clip_min.x + KX_Viewport.x, (int)((float)fb_height - clip_max.y + KX_Viewport.y), (int)(clip_max.x - clip_min.x), (int)(clip_max.y - clip_min.y)));
...
static void ImGui_ImplOpenGL3_RenderWindow(ImGuiViewport* viewport, void*)
{
    ...
    ImGui_ImplOpenGL3_RenderDrawData(viewport->DrawData, ImVec2(0, 0)); // RangeEngine: Unusable
}
