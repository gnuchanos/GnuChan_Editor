...
/** \file audaspace/OpenAL/OpenALReverbEffect.h
 *  \ingroup audopenal
 */

#ifndef __OPENALREVERBEFFECT_H__
#define __OPENALREVERBEFFECT_H__

#include "../include/fx/GEEffects/IOpenALEffectParams.h"

class OpenALReverbEffect : public IOpenALEffectParams
{
public:
	OpenALReverbEffect();
	void setOpenALParameters(ALuint slot, ALuint effect_id);

	void applyParams(ALuint effect);
	void applyParameter(ALenum param, float value);
