...
PyInit_aud()
{
	...
	// SoundEffectType. Game Engine
	PY_MODULE_ADD_CONSTANT(module, AUDIO_EFFECT_INVALID);
	PY_MODULE_ADD_CONSTANT(module, AUDIO_EFFECT_REVERB);
	// SoundFilterType. Game Engine
	PY_MODULE_ADD_CONSTANT(module, AUDIO_FILTER_INVALID);
	PY_MODULE_ADD_CONSTANT(module, AUDIO_FILTER_LOWPASS);
	PY_MODULE_ADD_CONSTANT(module, AUDIO_FILTER_HIGHPASS);
	PY_MODULE_ADD_CONSTANT(module, AUDIO_FILTER_BANDPASS);
