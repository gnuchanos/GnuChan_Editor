...
FileData *blo_openblenderfile_game(const char *filepath, struct ReportList *reports);
...
void blo_do_versions_range(struct FileData *fd, struct Library *lib, struct Main *main);
