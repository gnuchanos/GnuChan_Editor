...
static PyObject *PyInit_gpu(void)
{
	...
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_LAMP_DYNAREARIGHT);
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_LAMP_DYNAREAUP);
	...
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_ENVLIGHT_ENERGY);
	...
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_MAT_ROUGHNESS);
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_MAT_METALLIC);
