...
typedef enum GPUDynamicType {
	...
	GPU_DYNAMIC_LAMP_CSMPROPORTION	 = 16 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_COEFFCONST	   	 = 17 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_COEFFLIN		 = 18 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_COEFFQUAD		 = 19 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_CUTOFF			 = 20 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_DYNVISI		 = 21 | GPU_DYNAMIC_GROUP_LAMP,
