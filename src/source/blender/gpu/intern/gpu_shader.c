...
extern char datatoc_gpu_shader_fx_vignette_frag_glsl[];
	...
	if (!GG.shaders.fx_shaders[offset]) {
		...
		switch (effect) {
			...
			case GPU_SHADER_FX_VIGNETTE:
				shader = GPU_shader_create(datatoc_gpu_shader_fx_vert_glsl, datatoc_gpu_shader_fx_vignette_frag_glsl, NULL, datatoc_gpu_shader_fx_lib_glsl, defines, 0, 0, 0);
				break;
