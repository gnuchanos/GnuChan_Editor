...
typedef enum GPUFXShaderEffect {
	...
	GPU_SHADER_FX_SSR = 11,
	/* Bloom shader */
	GPU_SHADER_FX_BLOOM = 12,
	/* Tonemap shader */
	GPU_SHADER_FX_TONEMAP = 13,
	/* Light Scatter shader */
	GPU_SHADER_FX_LIGHTSCATTER = 14,
	/* FXAA shader */
	GPU_SHADER_FX_FXAA = 15,
	/* Vignette shader */
	GPU_SHADER_FX_VIGNETTE = 16
} GPUFXShaderEffect;

/* keep in synch with enum above! */
#define MAX_FX_SHADERS 17
