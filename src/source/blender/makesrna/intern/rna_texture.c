...
static void rna_def_mtex(BlenderRNA *brna)
{
	...
	static const EnumPropertyItem prop_tex_channel_items[] = {
		{TEX_INTRGB, "RGBTOINT", ICON_SOLID, "Gray", ""},
		{TEX_R_INT, "R_CHANNEL", ICON_COLOR_RED, "Red", ""},
		{TEX_G_INT, "G_CHANNEL", ICON_COLOR_GREEN, "Green", ""},
		{TEX_B_INT, "B_CHANNEL", ICON_COLOR_BLUE, "Blue", ""},
		{TEX_A_INT, "A_CHANNEL", ICON_IMAGE_ALPHA, "Alpha", ""},
		{0, NULL, 0, NULL, NULL}
	};
	...
	RNA_def_property_ui_text(prop, "RGB to Intensity", "Convert texture colors to grayscale intensity");
	RNA_def_property_update(prop, 0, "rna_TextureSlot_update");

	prop = RNA_def_property(srna, "use_rgb_to_orm", PROP_BOOLEAN, PROP_NONE);
	RNA_def_property_boolean_sdna(prop, NULL, "texflag", MTEX_ALPHAMIX);
	RNA_def_property_ui_text(prop, "RGB to ORM", "Interpret texture RGB as Occlusion, Roughness and Metalness");
	RNA_def_property_update(prop, 0, "rna_TextureSlot_update");

	prop = RNA_def_property(srna, "channel", PROP_ENUM, PROP_NONE);
	RNA_def_property_enum_sdna(prop, NULL, "gray_mode");
	RNA_def_property_enum_items(prop, prop_tex_channel_items);
	RNA_def_property_ui_text(prop, "Texture Channel", "How to get intensity values from texture data");
	RNA_def_property_update(prop, 0, "rna_TextureSlot_update");
