...
void RNA_def_world(BlenderRNA *brna)
{
	...
	prop = RNA_def_property(srna, "fog_color", PROP_FLOAT, PROP_COLOR);
	RNA_def_property_float_sdna(prop, NULL, "fogr");
	RNA_def_property_array(prop, 3);
	RNA_def_property_ui_text(prop, "Fog Color", "Color at the fog");
	RNA_def_property_update(prop, 0, "rna_World_draw_update");
