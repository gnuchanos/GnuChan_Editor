...
typedef struct Main {
	...
	short rangeversionfile, rangesubversionfile, rangeminsubversionfile;
...
#define MAIN_VERSION_RANGE_ATLEAST(main, ver, subver, minsubver) \
	((main)->rangeversionfile > (ver) || \
	 (main)->rangeversionfile == (ver) && (main)->rangesubversionfile > (subver) || \
	 (main)->rangeversionfile == (ver) && (main)->rangesubversionfile == (subver) && (main)->rangeminsubversionfile >= (minsubver))
