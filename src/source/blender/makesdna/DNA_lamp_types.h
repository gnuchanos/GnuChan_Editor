...
typedef struct Lamp {
	...
	float bias, bias_two, bias_three, slopebias, soft, soft_two, soft_three, compressthresh;
	float bleedbias, pad;
	float bufsharp;
	short bufsize, samp, buffers, filtertype;
	short bufsizetwo, bufsizethree;
	...
	float csm_proportion_two, csm_proportion_three;  /* BGE Only */
...
#define LA_CSM_SHADOW (1 << 20)
#define LA_CSM_DEBUG_SHADOW (1 << 21)
