...
DEF_ICON_OBJECT_DATA(LAMP_DATA)
...
DEF_ICON_OBJECT_DATA(GROUP) // Range 2.0: DEF_ICON_COLLECTION
...
DEF_ICON_OBJECT(OUTLINER_OB_LAMP)
...
DEF_ICON_OBJECT_DATA(OUTLINER_DATA_LAMP)
...
DEF_ICON_BLANK(142b)
	...
	/* PRIMITIVES */
DEF_ICON_OBJECT_DATA(MESH_PLANE)
DEF_ICON_OBJECT_DATA(MESH_CUBE)
DEF_ICON_OBJECT_DATA(MESH_CIRCLE)
DEF_ICON_OBJECT_DATA(MESH_UVSPHERE)
DEF_ICON_OBJECT_DATA(MESH_ICOSPHERE)
DEF_ICON_OBJECT_DATA(MESH_GRID)
DEF_ICON_OBJECT_DATA(MESH_MONKEY)
DEF_ICON_OBJECT_DATA(MESH_CYLINDER)
DEF_ICON_OBJECT_DATA(MESH_TORUS)
DEF_ICON_OBJECT_DATA(MESH_CONE)
DEF_ICON_OBJECT_DATA(MESH_CAPSULE)
DEF_ICON_BLANK(611)
DEF_ICON_SHADING(LAMP_POINT)
DEF_ICON_SHADING(LAMP_SUN)
DEF_ICON_SHADING(LAMP_SPOT)
DEF_ICON_SHADING(LAMP_HEMI)
DEF_ICON_SHADING(LAMP_AREA)
DEF_ICON_BLANK(617)
DEF_ICON_BLANK(618)
DEF_ICON(META_EMPTY)
DEF_ICON(META_PLANE)
