...
{
	/* identifiers */
	ot->name = "Pack Range Libraries";
	ot->idname = "FILE_OT_pack_libraries";
	ot->description = "Pack all used Range library files into the current .range";
...
{
	return WM_operator_confirm_message(C, op, "Unpack Range Libraries - creates directories, all new paths should work");
}

void FILE_OT_unpack_libraries(wmOperatorType *ot)
{
	/* identifiers */
	ot->name = "Unpack Range Libraries";
	ot->idname = "FILE_OT_unpack_libraries";
	ot->description = "Unpack all used Range library files from this .range file";
...
{
	/* identifiers */
	ot->name = "Automatically Pack Into .range";
	ot->idname = "FILE_OT_autopack_toggle";
	ot->description = "Automatically pack all external files into the .range file";
...
{
	/* identifiers */
	ot->name = "Pack All Into .range";
	ot->idname = "FILE_OT_pack_all";
	ot->description = "Pack all used external files into the .range";
