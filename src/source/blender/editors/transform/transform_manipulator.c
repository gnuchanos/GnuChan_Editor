                                  ...
                                  const int axis_order[3], const bool is_picksel)
{
	...
	for (i = 0; i < 3; i++) {
		draw_manipulator_planar_axes_single(v3d, rv3d, colcode, flagx, flagy, flagz, axis_order[i], is_picksel, GL_QUADS);
		draw_manipulator_planar_axes_single(v3d, rv3d, colcode, flagx, flagy, flagz, axis_order[i], is_picksel, GL_LINE_STRIP);
	}
