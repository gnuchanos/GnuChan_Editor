...
protected:
	...
	// Hack fix: Check if m_physCtrl is already registered in the PhysicsEnvironment. This is necessary because i think LibFree may try to free the data again.
	bool m_physCtrl_Libload;
