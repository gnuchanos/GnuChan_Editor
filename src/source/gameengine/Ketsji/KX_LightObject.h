...
public:
	...
	static PyObject *pyattr_get_shadow_bind_code_two(EXP_PyObjectPlus *self_v, const EXP_PYATTRIBUTE_DEF *attrdef);
	static PyObject *pyattr_get_shadow_bind_code_three(EXP_PyObjectPlus *self_v, const EXP_PYATTRIBUTE_DEF *attrdef);
	...
	static PyObject *pyattr_get_shadow_matrix_two(EXP_PyObjectPlus *self_v, const EXP_PYATTRIBUTE_DEF *attrdef);
	static PyObject *pyattr_get_shadow_matrix_three(EXP_PyObjectPlus *self_v, const EXP_PYATTRIBUTE_DEF *attrdef);
	static PyObject *pyattr_get_shadow_csm_proportion_two(EXP_PyObjectPlus *self_v, const EXP_PYATTRIBUTE_DEF *attrdef);
	static PyObject *pyattr_get_shadow_csm_proportion_three(EXP_PyObjectPlus *self_v, const EXP_PYATTRIBUTE_DEF *attrdef);
