	...
	:m_scene(blenderscene)
{
	if (blenderworld) {
		...
		setMistColor(mt::vec3(blenderworld->fogr, blenderworld->fogg, blenderworld->fogb));
...
PyAttributeDef KX_WorldInfo::Attributes[] = {
	...
	EXP_PYATTRIBUTE_FLOAT_RW("mistHeight", 0.0f, 100.0f, KX_WorldInfo, m_mistheight),
	EXP_PYATTRIBUTE_FLOAT_RW("mistDensity", 0.0f, 100.0f, KX_WorldInfo, m_mistdensity),
