...
/** \file KX_PythonKeyboard.h
 *  \ingroup ketsji
 */

#ifndef __KX_PythonKeyboard_H__
#define __KX_PythonKeyboard_H__

#include "EXP_PyObjectPlus.h"

class KX_PythonKeyboard : public EXP_PyObjectPlus
{
	Py_Header
private:
...
public:
	KX_PythonKeyboard(class SCA_IInputDevice* keyboard);
	virtual ~KX_PythonKeyboard();
