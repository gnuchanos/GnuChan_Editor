...
public:
	...
	enum FILTER_RESERVED_PASS {
		FILTERPASS_SSR_BUFFER      = 0,
		FILTERPASS_SSAO_BUFFER     = 1,

		FILTERPASS_SSR_BLUR        = 2,
		FILTERPASS_SSAO_BLUR       = 3,

		FILTERPASS_BLOOM_BUFFER	   = 4,
		/* BLOOM BUFFER [4 ~ 11] */

		FILTERPASS_SSR_IMAGE       = 100,
		FILTERPASS_SSAO_IMAGE      = 101,

		FILTERPASS_BLOOM_IMAGE     = 102,
		/* BLOOM HAS EXTRA PASSES .. [6 ~ 13] */
		FILTERPASS_LIGHTSCATTER    = 109,
		/* LIGHTSCATTER HAS EXTRA PASSES .. [14 ~ 15] */
		FILTERPASS_FXAA            = 111,
		FILTERPASS_TONEMAP         = 112,
		FILTERPASS_VIGNETTE        = 113
	};
	// number of steps reserved for BuildInFilters, this means that any filters added later will be relocated to later steps
	const int reservedPassIndex = 11;
