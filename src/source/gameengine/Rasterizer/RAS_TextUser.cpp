...
const bool RAS_TextUser::GetUseShadows() const
{
  return m_use_shadows;
}

const mt::vec2& RAS_TextUser::GetShadowOffset() const
{
  return m_shadow_offset;
}

const mt::vec4& RAS_TextUser::GetShadowColor() const
{
	return m_shadow_col;
}
...
void RAS_TextUser::SetUseShadows(bool enable)
{
	m_use_shadows = enable;
}

void RAS_TextUser::SetShadowOffset(mt::vec2 shadow_offset)
{
	m_shadow_offset = shadow_offset;
}

void RAS_TextUser::SetShadowColor(mt::vec4 shadow_col)
{
	m_shadow_col = shadow_col;
}
