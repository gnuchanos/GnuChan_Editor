...
public:
	...
	virtual void SetFullScreen(int type) = 0;
...
protected:
	...
	only for use in debug mouse. should not affect for the player. */
	bool debugmode_allowmouse = false;
