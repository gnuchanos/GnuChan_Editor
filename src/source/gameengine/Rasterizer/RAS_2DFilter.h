...
public:
	enum PredefinedUniformType {
		...
		GE_TONEMAP_COLOR_PARAMETERS_UNIFORM,
		...
		GE_SSAO_GI_PARAMETERS_UNIFORM,
		GE_VIGNETTE_PARAMETERS_UNIFORM,
...
protected:
	...
	void BindUniforms(RAS_ICanvas *canvas, const float (&sun_screen_pos)[2]);
